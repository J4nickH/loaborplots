...
amplitude_ticks = [-5, 0, 5, 10, 15, 20]
...
line2 = ax2.semilogx(frequenz, spalte_phase, color='red', label='Phase [°]', linestyle = "--") #marker='s')
...
plt.tight_layout()
plt.savefig("Bodelab3lt.png", dpi=300)
plt.show()